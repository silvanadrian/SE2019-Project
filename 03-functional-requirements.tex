...
A duplicate cases are annotated and they are clearly presented for the caseworker as such. The caseworker can confirm a case to be  In case the System annotated a case as a possible duplicate and the caseworker decides this to be true, then the case state must be changed to rejected.
