...
Duplicate cases are annotated and are clearly presented for the caseworker as such. The caseworker can mark the application as not duplicate or confirm it as a duplicate. In case the application is confirmed as duplicate by the caseworker, the case is rejected and archived. Otherwise, the case is changed to ongoing and follows a standard process for ongoing cases.
